...
query=input("query:")
print(query)
#NOTE 1: this search is case sensitive...
#NOTE 2: because I'm creating a set split on spaces, punctuation now counts, such that
#        "happen" is not thes same as "happen,";
not_found = True
for quote in data_list:
  nugs = query.split(" ")
  query_set = set(nugs)
  quote_set = set(quote.split(" "))
  if query_set | quote_set == quote_set:
    loc = quote.find(nugs[0])
    print("Found: {}...".format(quote[loc:loc+50]))
    not_found = False
