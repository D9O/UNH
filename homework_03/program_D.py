...
def Normalize_Query(query):
  ...
  if paren_chk != 0:
    return PAREN_ERROR
  if AND not in query and OR not in query: #Fix one-word searches condition and/or
                                           #add a default AND to searches with 
                                           #no OPERATORS, e.g. >this that none< becomes
                                           #>this AND that AND none
    #print("Fixing Query...")
    fixed = ""
    if query.count(" ") > 0:
      nugs = query.strip().split(" ")
      while len(nugs) > 1:
        fixed += "{} AND ".format(nugs.pop())
      fixed += "{}".format(nugs.pop())
      query = fixed
      #print("fixed query = {}".format(query))
    else:
      query = "{} AND {}".format(query, query)      
      #print("fixed query = {}".format(query))
  return "( {} )".format(query)
...
#Example query:
'''
andyd@AndyDs-MBP homework_03 % python3 20210206_program44.py
query: (((young OR men) AND love) OR stars)   

QUERY >(((young OR men) AND love) OR stars)<


You - you alone will have the ###stars### as no one else has them...In one of the 
###stars### I shall be living. In one of them I shall be laughing. And so it will be as if 
all the ###stars### were laughing, when you look at the sky at night...You - only you - 
...
the ###stars### always make me laugh!' And they will think you are crazy. It will be a 
...
little lights in the sky. For others, who are scholars, they are problems... But all these
###stars### are silent. You-You alone will have ###stars### as no one else has them... In 
one of the ###stars### I shall be living. In one of them I shall be laughing. And so it 
will be as if all the ###stars### will be laughing when you look at the sky at night..You, 
only you, will have ###stars### that can laugh! And when your sorrow is comforted (time 
...
that pleasure... It will be as if, in place of the ###stars###, I had given you a great 
number of little bells that knew how to laugh


She cast her fragrance and her radiance over me. I ought never to have run away from 
her... I ought to have guessed all the affection that lay behind her poor little 
stratagems. Flowers are so inconsistent! But I was too ###young### to know how to 
###love### her...


In those days, I didn't understand anything. I should have judged her according to her 
actions, not her words. She perfumed my planet and lit up my life. I should never have run
away! I ought to have realized the tenderness underlying her silly pretensions. Flowers 
are so contadictory! But I was too ###young### to know how to ###love### her.


I was too ###young### to know how to ###love### her.


For millions of years flowers have been producing thorns. For millions of years sheep have
been eating them all the same. And it's not serious, trying to understand why flowers go 
to such trouble to produce thorns that are good for nothing? It's not important, the war
between the sheep and the flowers? It's no more serious and more important than the
numbers that fat red gentleman is adding up? Suppose I happen to know a unique flower, one
that exists nowhere in the world except on my planet, one that a little sheep can wipe out
in a single bite one morning, just like that, without even realizing what he'd doing - 
that isn't important? If someone ###love###s a flower of which just one example exists 
among all the millions and millions of ###stars###, that's enough to make him happy when 
he looks at the ###stars###. He tells himself 'My flower's up there somewhere...' But if 
the sheep eats the flower, then for him it's as if, suddenly, all the ###stars### went 
out. And that isn't important?


People have ###stars###, but they aren't the same. For travelers, the ###stars### are 
guides. For other people, they're nothing but tiny lights. And for still others, for 
scholars, they're problems... But all those ###stars### are silent ###stars###. You, 
though, you'll have ###stars### like nobody else... since I'll be laughing on one of them, 
for you it'll be as if all the ###stars### are laughing. You'll have ###stars### that can 
laugh!... and it'll be as if I had given you, instead of ###stars###, a lot of tiny bells 
...
If you ###love### a flower that lives on a star, then it's good at night, to look up at 
the sky. All the ###stars### are blossoming.
'''